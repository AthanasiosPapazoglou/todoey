...
class newRecordSheet extends StatelessWidget {
  final Function
      addTaskCallback; //Η CBfunction που θα φερει τη λειτουργικοτητα τοποθετησης τιμης στη λιστα
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            TextField(
              //Το textField εχει χαρακτηρα input, όποτε εκτελείται keystroke στο πεδιο του αυτοματα το value του πεδιου ανανεωνεται
            ...
            FlatButton(
              //Το Button εκτελει τη λειτουργικοτητα καταθεσης της τιμης του textfield ως καινουργια εγγραφη στη λιστα todos
              child: Text(
                'Submit',
                style: TextStyle(
                  color: Colors.white,
